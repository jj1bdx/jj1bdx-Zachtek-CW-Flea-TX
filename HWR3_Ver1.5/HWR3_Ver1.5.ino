...
#define FilterRelay A2 //Output to Relay that will pick etiher 40m filter or 30/20m filter.  LOW= 40m filter
...
long Band40mbottom = 700000000; //Lowest frequency of 40m Band CentiHertz. 100 CentiHertz=1Hz
